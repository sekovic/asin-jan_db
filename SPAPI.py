...
#            print("asin::::"+asin)
            #JAN
            if 'externally_assigned_product_identifier' in item['attributes']:
...
def main():
    ...
    input_codes_str="B0752BSCY7,B01NCXFWIZ,B01N5QLLT3,B075MK6THW,B079TG39FD,B01NBW07L4,B01M1VMFUA,B079T6CHPV,B01NCX1VU6"
